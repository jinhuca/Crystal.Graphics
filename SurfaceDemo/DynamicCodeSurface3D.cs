...
{
  public class DynamicCodeSurface3D : ParametricModelVisual3D
  {
    ...
    public static readonly DependencyProperty ParameterWProperty = DependencyProperty.Register(
      nameof(ParameterW), typeof(double), typeof(DynamicCodeSurface3D), new UIPropertyMetadata(1.0, SourceChanged));
    ...
    public static readonly DependencyProperty SourceProperty = DependencyProperty.Register(
      nameof(Source), typeof(string), typeof(DynamicCodeSurface3D), new UIPropertyMetadata(null, SourceChanged));
