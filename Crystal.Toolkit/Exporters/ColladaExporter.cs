  ...
  public class ColladaExporter : Exporter<XmlWriter>
    {
        ...
        public override void Export(Viewport3D viewport, System.IO.Stream stream)
        {
            ...
            viewport.Children.Traverse<GeometryModel3D>((gm, t) => ExportMaterial(writer, gm));
            writer.WriteEndElement();

            writer.WriteStartElement("library_effects");
            viewport.Children.Traverse<GeometryModel3D>((gm, t) => ExportEffect(writer, gm));
            writer.WriteEndElement();
        ...
        private void ExportMaterial(XmlWriter writer, Material m)
        {
            ...
            string id = "material_" + materials.Count;
            string effectid = "effect_" + materials.Count;
            materials.Add(m, id);
        ...
        private void ExportNode(XmlWriter writer, GeometryModel3D gm, Transform3D transform)
        {
            ...
            string geometryId = geometries[mg];
            ...
            if (gm.Material != null && materials.TryGetValue(gm.Material, out frontMaterialId))
            {
                BindMaterial(writer, geometryId, frontMaterialId);
            }

            if (gm.BackMaterial != null && materials.TryGetValue(gm.BackMaterial, out backMaterialId))
            {
