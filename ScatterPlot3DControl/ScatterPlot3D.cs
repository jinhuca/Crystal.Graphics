...
namespace ScatterPlot3DControl
{
  public class ScatterPlot3D : CrystalViewport3D
  {
    static ScatterPlot3D()
    {
      DefaultStyleKeyProperty.OverrideMetadata(typeof(ScatterPlot3D), new FrameworkPropertyMetadata(typeof(ScatterPlot3D)));
    }

    #region Dependency Properties

    public static readonly DependencyProperty PointsProperty = DependencyProperty.Register(
      nameof(Points), typeof(Point3D[]), typeof(ScatterPlot3D), new UIPropertyMetadata(null, ModelChanged));
    ...
    public static readonly DependencyProperty ValuesProperty = DependencyProperty.Register(
      nameof(Values), typeof(double[]), typeof(ScatterPlot3D), new UIPropertyMetadata(null, ModelChanged));
    ...
    public static readonly DependencyProperty SurfaceBrushProperty = DependencyProperty.Register(
      nameof(SurfaceBrush), typeof(Brush), typeof(ScatterPlot3D), new UIPropertyMetadata(null, ModelChanged));
    ...
    public static readonly DependencyProperty IntervalXNewProperty = DependencyProperty.Register(
      nameof(IntervalX), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(1.0d, ModelChanged));
    ...
    public static readonly DependencyProperty IntervalYProperty = DependencyProperty.Register(
      nameof(IntervalY), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(1.0d, ModelChanged));
    ...
    public static readonly DependencyProperty IntervalZProperty = DependencyProperty.Register(
      nameof(IntervalZ), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(1.0d, ModelChanged));
    ...
    public static new readonly DependencyProperty FontSizeProperty = DependencyProperty.Register(
      nameof(FontSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(.1d, ModelChanged));
    ...
    public static readonly DependencyProperty SphereSizeProperty = DependencyProperty.Register(
      nameof(SphereSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(.15d, ModelChanged));
    ...
    public static readonly DependencyProperty BoundingBoxThicknessProperty = DependencyProperty.Register(
      nameof(BoundingBoxThickness), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(0.003d, ModelChanged));
    ...
    public static readonly DependencyProperty BoundingBoxMaterialProperty = DependencyProperty.Register(
      nameof(BoundingBoxMaterial), typeof(Material), typeof(ScatterPlot3D), new UIPropertyMetadata(Materials.Black, ModelChanged));
    ...
    public static readonly DependencyProperty XAxisTitleContentProperty = DependencyProperty.Register(
      nameof(XAxisTitleContent), typeof(string), typeof(ScatterPlot3D), new UIPropertyMetadata("X-axis", ModelChanged));
    ...
    public static readonly DependencyProperty XAxisTitleFontSizeProperty = DependencyProperty.Register(
      nameof(XAxisTitleFontSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(0.1d, ModelChanged));
    ...
    public static readonly DependencyProperty XAxisTitleBrushProperty = DependencyProperty.Register(
      nameof(XAxisTitleBrush), typeof(Brush), typeof(ScatterPlot3D), new UIPropertyMetadata(Brushes.Black, ModelChanged));
    ...
    public static readonly DependencyProperty XAxisLabelBrushProperty = DependencyProperty.Register(
      nameof(XAxisLabelBrush), typeof(Brush), typeof(ScatterPlot3D), new UIPropertyMetadata(Brushes.Blue, ModelChanged));
    ...
    public static readonly DependencyProperty XAxisLabelFontSizeProperty = DependencyProperty.Register(
      nameof(XAxisLabelFontSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(0.1d, ModelChanged));
    ...
    public static readonly DependencyProperty YAxisTitleContentProperty = DependencyProperty.Register(
      nameof(YAxisTitleContent), typeof(string), typeof(ScatterPlot3D), new UIPropertyMetadata("Y-Axis", ModelChanged));
    ...
    public static readonly DependencyProperty YAxisTitleFontSizeProperty = DependencyProperty.Register(
      nameof(YAxisTitleFontSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(0.1d, ModelChanged));
    ...
    public static readonly DependencyProperty YAxisTitleBrushProperty = DependencyProperty.Register(
      nameof(YAxisTitleBrush), typeof(Brush), typeof(ScatterPlot3D), new UIPropertyMetadata(Brushes.Black, ModelChanged));
    ...
    public static readonly DependencyProperty YAxisLabelBrushProperty = DependencyProperty.Register(
      nameof(YAxisLabelBrush), typeof(Brush), typeof(ScatterPlot3D), new UIPropertyMetadata(Brushes.Blue, ModelChanged));
    ...
    public static readonly DependencyProperty YAxisLabelFontSizeProperty = DependencyProperty.Register(
      nameof(YAxisLabelFontSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(0.1d, ModelChanged));
    ...
    public static readonly DependencyProperty ZAxisTitleContentProperty = DependencyProperty.Register(
      nameof(ZAxisTitleContent), typeof(string), typeof(ScatterPlot3D), new UIPropertyMetadata("Z-axis", ModelChanged));
    ...
    public static readonly DependencyProperty ZAxisTitleFontSizeProperty = DependencyProperty.Register(
      nameof(ZAxisTitleFontSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(0.1d, ModelChanged));
    ...
    public static readonly DependencyProperty ZAxisTitleBrushProperty = DependencyProperty.Register(
      nameof(ZAxisTitleBrush), typeof(Brush), typeof(ScatterPlot3D), new UIPropertyMetadata(Brushes.Black, ModelChanged));
    ...
    public static readonly DependencyProperty ZAxisLabelBrushProperty = DependencyProperty.Register(
      nameof(ZAxisLabelBrush), typeof(Brush), typeof(ScatterPlot3D), new UIPropertyMetadata(Brushes.Blue, ModelChanged));
    ...
    public static readonly DependencyProperty ZAxisLabelFontSizeProperty = DependencyProperty.Register(
      nameof(ZAxisLabelFontSize), typeof(double), typeof(ScatterPlot3D), new UIPropertyMetadata(0.1d, ModelChanged));
    ...
    {
      ((ScatterPlot3D)dpObj).UpdateModel();
    }
